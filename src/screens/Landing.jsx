...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-500 relative overflow-x-hidden">
      ...
      {/* Header */}
      <header className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-white/10 sticky top-0 z-50 shadow-sm transition-colors duration-300">
